                    ...
                    <ScrollView>
                        <View>
                            <View style={styles.headtitle}>
                                ...
                                <Image source={require('../../images/ride_pass.png')} style={{ width: '100%', height: 150, marginTop: 15 }} />
                            </View>
                            ...
                            <View style={styles.headtitle}>
                                ...
                                <View style={styles.borderview}>
                                    <TouchableOpacity>
                                        <Text style={styles.optiontxt}>Payment info not accepted</Text>
                                    </TouchableOpacity>
                                </View>
                                <View style={styles.borderview}>
                                    <TouchableOpacity>
                                        <Text style={styles.optiontxt}>Promo, credit, or coupon issue</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                            <View style={styles.border}></View>
                            ...
                            <View style={styles.gridcontainer}>
                                ...
                                <View style={styles.gridview}>
                                    <TouchableOpacity>
                                        ...
                                        <View style={styles.gridimage}>
                                            <Image source={require('../../images/sherlock.jpg')} style={styles.gridimages} />
                                        </View>
                                        <View style={styles.gridviewtext}>
                                            <Text style={styles.gridtxt}>Profile and account settings</Text>
                                        </View>
                                    </TouchableOpacity>
                                </View>
                                ...
                                <View style={styles.gridview}>
                                    <TouchableOpacity>
                                        ...
                                        <View style={styles.gridviewtext}>
                                            <Text style={styles.gridtxt}>Promos, credits and rewards</Text>
                                        </View>
                                    </TouchableOpacity>
                                </View>
